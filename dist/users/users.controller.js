...
const userShow_dto_1 = require("../users/dtos/userShow-dto");
...
let UsersController = class UsersController {
    ...
    async findUser(id) {
        ...
        if (!user) {
            throw new common_1.NotFoundException("没找到");
        }
        return user;
    }
    findAllUser(email) {
...
UsersController = __decorate([
    ...
    (0, serialize_interceptors_1.serialize)(userShow_dto_1.userShowDto),
